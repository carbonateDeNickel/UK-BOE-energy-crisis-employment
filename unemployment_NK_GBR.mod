...
oox = oo_;
% change parameter
Mx.params(strcmp('phi_y',M_.param_names)) = 0.5; % on simule le cas où la PM de la BoE serait moins sensible à l'objectif de stabilité des prix
